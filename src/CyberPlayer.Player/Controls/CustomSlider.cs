...
public class CustomSlider : CustomRangeBase
{
    /// <summary>
    /// Defines the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly StyledProperty<Orientation> OrientationProperty =
        ScrollBar.OrientationProperty.AddOwner<CustomSlider>();

    /// <summary>
    /// Defines the <see cref="IsDirectionReversed"/> property.
    /// </summary>
    public static readonly StyledProperty<bool> IsDirectionReversedProperty =
        Track.IsDirectionReversedProperty.AddOwner<CustomSlider>();

    /// <summary>
    /// Defines the <see cref="IsSnapToTickEnabled"/> property.
    /// </summary>
    public static readonly StyledProperty<bool> IsSnapToTickEnabledProperty =
        AvaloniaProperty.Register<CustomSlider, bool>(nameof(IsSnapToTickEnabled), false);

    /// <summary>
    /// Defines the <see cref="TickFrequency"/> property.
    /// </summary>
    public static readonly StyledProperty<double> TickFrequencyProperty =
        AvaloniaProperty.Register<CustomSlider, double>(nameof(TickFrequency), 0.0);

    /// <summary>
    /// Defines the <see cref="TickPlacement"/> property.
    /// </summary>
    public static readonly StyledProperty<TickPlacement> TickPlacementProperty =
        AvaloniaProperty.Register<CustomSlider, TickPlacement>(nameof(TickPlacement), 0d);

    /// <summary>
    /// Defines the <see cref="Ticks"/> property.
    /// </summary>
    public static readonly StyledProperty<AvaloniaList<double>?> TicksProperty =
        TickBar.TicksProperty.AddOwner<CustomSlider>();
    
    public static readonly StyledProperty<bool> IsDraggingProperty =
        AvaloniaProperty.Register<CustomSlider, bool>(nameof(IsDragging), false, defaultBindingMode: BindingMode.OneWayToSource);
    ...
    static CustomSlider()
    {
        PressedMixin.Attach<CustomSlider>();
        FocusableProperty.OverrideDefaultValue<CustomSlider>(true);
        OrientationProperty.OverrideDefaultValue(typeof(CustomSlider), Orientation.Horizontal);
        Thumb.DragStartedEvent.AddClassHandler<CustomSlider>((x, e) => x.OnThumbDragStarted(e), RoutingStrategies.Bubble);
        Thumb.DragCompletedEvent.AddClassHandler<CustomSlider>((x, e) => x.OnThumbDragCompleted(e),
            RoutingStrategies.Bubble);

        ValueProperty.OverrideMetadata<CustomSlider>(new(enableDataValidation: true));
        AutomationProperties.ControlTypeOverrideProperty.OverrideDefaultValue<CustomSlider>(AutomationControlType.Slider);
    }
    ...
    internal void MoveToPoint(PointerPoint posOnTrack)
    {
        if (_track is null)
            return;
...
{
    public CustomSliderAutomationPeer(RangeBase owner) : base(owner)
    {
    }
